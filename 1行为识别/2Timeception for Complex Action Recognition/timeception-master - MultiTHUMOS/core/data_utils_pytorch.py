...
class DatasetMultiTHUMOS(torch.utils.data.Dataset):
    def __init__(self, batch_size, n_classes, feature_dim, feature_name, is_training, data_path, is_shuffle=True):
        """
        Initialization
        """
        ...
        self.feature_name = feature_name #'features_i3d_pytorch_charades_rgb_mixed_5c_32f'
        self.is_shuffle = is_shuffle
        self.dataset_name = 'MultiTHUMOS'

        # load annotation
        # root_path = '/data/pengzhen/NAS_AR_CNN/data/Charades' #常老师服务器
        annotation_path = '/home/amax/renpengzhen/timeception-master - MultiTHUMOS/data/MultiTHUMOS/annotations/MultiTHUMOS_annotations_mult_labels.pkl'#视频注释./data/Charades/annotation/video_annotation.pkl
...
PYTORCH_DATASETS_DICT = {'Charades': DatasetCharades,'MultiTHUMOS':DatasetMultiTHUMOS} #dataset_class = data_utils.PYTORCH_DATASETS_DICT[charades]
# endregion
