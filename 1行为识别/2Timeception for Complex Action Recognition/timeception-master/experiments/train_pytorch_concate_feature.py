...
def train_tco(data_path,concate_feature=False,random_sample = False):
    ...
    model_path = '/home/amax/renpengzhen/timeception-master/data/Charades/models/charades_timeception_128_19.12.24-09:32:11/T128-009-33.04.pt'
    after_epoch = 0
    if after_epoch>0:
    ...
    for idx_epoch in range(n_epochs):
        epoch_num = idx_epoch + 1 + after_epoch
        # print(epoch_num)
        loss_tr = 0.0
        loss_te = 0.0
        tt1 = time.time()
...
def __define_loader(data_path,is_training):
    ...
    feature_name = 'features_%s_%s_%sf_ConcateFeature' % (backbone_model_name, backbone_feature_name, n_timesteps) #'features _i3d_pytorch_charades_rgb_ mixed_5c_32f'
