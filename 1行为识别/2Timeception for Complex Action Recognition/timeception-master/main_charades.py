...
def default_config(n_timestep_in):
    if n_timestep_in in [32,64]:
        ...
        default_config_file = 'charades_i3d_tc3_f%d.yaml'%cnn_n_timestep_in
    else:
        cnn_n_timestep_in = n_timestep_in * 8
        default_config_file = 'charades_i3d_tc4_f%d.yaml' % cnn_n_timestep_in
...
if __name__ == '__main__':
    ...
    train_pytorch_concate_feature.__main(data_path, default_config_file, concate_feature=True, random_sample=False) # 串联帧一起提取特征进行训练
    exit()
